...
Route::group(['namespace'=>'Web'],function(){	
  ...
  Route::get('/restaurantindex','frontController@restaurantindex')->name('restaurantindex');
  Route::get('pharmacyindex','frontController@pharmacyindex')->name('pharmacyindex');
  Route::get('parcalindex','frontController@parcalindex')->name('parcalindex');
  Route::post('groceryindex','frontController@groceryshoplistSearch')->name('groceryshoplistSearch');
  Route::post('restaurantindex','frontController@restaurantshoplistSearch')->name('restaurantshoplistSearch');
  Route::post('pharmacyindex','frontController@pharmacyshoplistSearch')->name('pharmacyshoplistSearch');
  Route::post('parcalindex','frontController@parcalshoplistSearch')->name('parcalshoplistSearch');

  Route::get('grocerylogin','frontController@grocerylogin')->name('grocerylogin');
  Route::get('pharmacylogin','frontController@pharmacylogin')->name('pharmacylogin');
  Route::post('groceryweblogin','frontController@groceryweblogin')->name('groceryweblogin');
  Route::post('pharmacyweblogin','frontController@pharmacyweblogin')->name('pharmacyweblogin');
  
  Route::get('resturant-login','frontController@resturantweblogin')->name('resturantweblogin');
//   Route::post('resturantlogin','frontController@resturantlogin')->name('resturantlogin');
  
   Route::get('parcel-login','frontController@parcelweblogin')->name('parcelweblogin');
   Route::get('parcel-signup','frontController@parcelwebsignup')->name('parcelwebsignup');
   Route::post('parcelsignup','frontController@parcelsignup')->name('parcelsignup');
  Route::post('parcellogin','frontController@parcellogin')->name('parcellogin');

  Route::get('grocerysignup','frontController@grocerysignup')->name('grocerysignup');
  Route::get('pharmacysignup','frontController@pharmacysignup')->name('pharmacysignup');
  Route::post('grocerywebsignup','frontController@grocerywebsignup')->name('grocerywebsignup');
  Route::post('pharmacywebsignup','frontController@pharmacywebsignup')->name('pharmacywebsignup');
  Route::get('resturantsignup','frontController@resturantsignup')->name('resturantsignup');
  Route::post('resturantwebsignup','frontController@resturantwebsignup')->name('resturantwebsignup');
    Route::get('groceryforgotpassword','frontController@groceryforgotpassword')->name('groceryforgotpassword');
  Route::post('grocerywebforgotpassword','frontController@grocerywebforgotpassword')->name('grocerywebforgotpassword');
  Route::post('groceryotpverifyforgot' ,'frontController@groceryotpverifyforgot')->name('groceryotpverifyforgot');
  Route::get('pharmacyforgotpassword','frontController@pharmacyforgotpassword')->name('pharmacyforgotpassword');
  Route::post('pharmacywebforgotpassword','frontController@pharmacywebforgotpassword')->name('pharmacywebforgotpassword');
  Route::post('pharmacyotpverifyforgot' ,'frontController@pharmacyotpverifyforgot')->name('pharmacyotpverifyforgot');

  Route::get('getforgotpassword','frontController@getforgotpassword')->name('getforgotpassword');

  Route::post('webforgotpassword','frontController@webforgotpassword')->name('webforgotpassword');
  Route::post('webotpverify','frontController@webotpverify')->name('webotpverify');
  Route::post('webupdatepassword','frontController@webupdatepassword')->name('webupdatepassword');
  Route::post('otpverifyforgotpassword' ,'frontController@otpverifyforgotpassword')->name('otpverifyforgotpassword');

    
  Route::get('resturantforgotpassword','frontController@resturantforgotpassword')->name('resturantforgotpassword');
  Route::post('resturantwebforgotpassword','frontController@resturantwebforgotpassword')->name('resturantwebforgotpassword');
   Route::post('resturantotpverifyforgot' ,'frontController@resturantotpverifyforgot')->name('resturantotpverifyforgot');
   
    Route::get('parcelforgotpassword','frontController@parcelforgotpassword')->name('parcelforgotpassword');
  Route::post('parcelwebforgotpassword','frontController@parcelwebforgotpassword')->name('parcelwebforgotpassword');
   Route::post('parcelotpverifyforgot' ,'frontController@parcelotpverifyforgot')->name('parcelotpverifyforgot');
   
   
   
  
  Route::get('groceryorder','frontController@groceryorder')->name('groceryorder');
  Route::get('pharmacyorder','frontController@pharmacyorder')->name('pharmacyorder');

  Route::post('websupport', 'frontController@websupport')->name('websupport');

	Route::get('groceryprofile','frontController@groceryprofile')->name('groceryprofile');
	Route::get('pharmacyprofile','frontController@pharmacyprofile')->name('pharmacyprofile');
  Route::get('weblogout','frontController@weblogout')->name('weblogout');
  
  	Route::get('resturantprofile','frontController@resturantprofile')->name('resturantprofile');
	Route::get('resturantorder','frontController@resturantorder')->name('resturantorder');
	
	
	Route::get('parcelprofile','frontController@parcelprofile')->name('parcelprofile');
	Route::get('parcelorder','frontController@parcelorder')->name('parcelorder');
	
	
 


  Route::get('groceryhome/{id}','groceryController@groceryhome')->name('groceryhome');
  Route::get('groceryproduct/{id}','groceryController@groceryproduct')->name('groceryproduct');
  Route::get('groceryproduct/getbyvarient/{id}','groceryController@varient');
  Route::post('addtobag','groceryController@addtobag')->name('addtobag');
  
  Route::post('grocerygetsubcat','groceryController@grocerygetsubcat')->name('grocerygetsubcat');
  // Route::post('grocerygetproduct','groceryController@productdetail')->name('grocerygetproduct');
	Route::post('grocerysearchcategory', 'groceryController@grocerysearchcategory')->name('grocerysearchcategory');
	Route::get('grocerycart','groceryController@grocerycart')->name('grocerycart');
  Route::get('grocerycheckout','groceryController@grocerycheckout')->name('grocerycheckout');
  Route::post('getproductlist','groceryController@getproductlist')->name('getproductlist');
  Route::post('updateqtycart','groceryController@updateqtycart')->name('updateqtycart');
  Route::post('removecartitem','groceryController@removecartitem')->name('removecartitem');
  Route::get('productdetail/{id}','groceryController@productdetail')->name('productdetail');
  Route::post('getproductdata','groceryController@getproductdata')->name('getproductdata');
	Route::post('getproductdetailschange','groceryController@getproductdetailschange')->name('getproductdetailschange');
  Route::get('gettimeslot','groceryController@gettimeslot')->name('gettimeslot');
  Route::post('selectaddress','groceryController@selectaddress')->name('selectaddress');
  Route::post('placeorder','groceryController@placeorder')->name('placeorder');
  //////////
  /////////
  Route::get('pharmacyhome/{id}','pharmacyController@pharmacyhome')->name('pharmacyhome');
  Route::get('pharmacyproductweb/{id}','pharmacyController@pharmacyproductweb')->name('pharmacyproductweb'); 
  Route::get('pharmacyproductweb/getbypharmacyvarient/{id}','pharmacyController@pharmacywebvarient');
  Route::get('pharmacyproductdetail/{id}','pharmacyController@pharmacyproductdetail')->name('pharmacyproductdetail');
	Route::post('getpharmacydetailschange','pharmacyController@getpharmacydetailschange')->name('getpharmacydetailschange');
	Route::post('pharmacyaddtobag','pharmacyController@pharmacyaddtobag')->name('pharmacyaddtobag');
	Route::get('pharmacycart','pharmacyController@pharmacycart')->name('pharmacycart');
  Route::get('pharmacycheckout','pharmacyController@pharmacycheckout')->name('pharmacycheckout');

  Route::post('pharmacyupdateqtycart','pharmacyController@pharmacyupdateqtycart')->name('pharmacyupdateqtycart');
  Route::post('pharmacyremovecartitem','pharmacyController@pharmacyremovecartitem')->name('pharmacyremovecartitem');
	Route::post('pharmacysearchcategory', 'pharmacyController@pharmacysearchcategory')->name('pharmacysearchcategory');
  Route::post('pharmacygetproductdata','pharmacyController@pharmacygetproductdata')->name('pharmacygetproductdata');
  Route::post('pharmacygetproductlist','pharmacyController@pharmacygetproductlist')->name('pharmacygetproductlist');
  Route::post('pharmacyplaceorder','pharmacyController@pharmacyplaceorder')->name('pharmacyplaceorder');

Route::get('webaboutus','frontController@webaboutus')->name('webaboutus');
Route::get('webterms','frontController@webterms')->name('webterms');
  ///////

Route::get('pharmacyaddaddressdetails','frontController@pharmacyaddaddressdetails')->name('pharmacyaddaddressdetails');
Route::get('pharmacyupdateaddressdetails/{id}','frontController@pharmacyupdateaddressdetails')->name('pharmacyupdateaddressdetails');

Route::get('parceladdaddressdetails','frontController@parceladdaddressdetails')->name('parceladdaddressdetails');

Route::post('parcelorderideatils','frontController@parcelorderideatils')->name('parcelorderideatils');


Route::get('resturantupdateaddressdetails/{id}','frontController@resturantupdateaddressdetails')->name('resturantupdateaddressdetails');

Route::get('parcelupdateaddressdetails/{id}','frontController@parcelupdateaddressdetails')->name('parcelupdateaddressdetails');




Route::get('addaddressdetails','frontController@addaddressdetails')->name('addaddressdetails');
Route::post('addaddressdetailsdata','frontController@addaddressdetailsdata')->name('addaddressdetailsdata');
Route::get('resturantaddaddressdetails','frontController@resturantaddaddressdetails')->name('resturantaddaddressdetails');

Route::get('getbyarealist/{id}','frontController@arealist');
Route::get('getbyeditarealist/{id}','frontController@arealist');
Route::get('updateaddressdetails/{id}','frontController@updateaddressdetails')->name('updateaddressdetails');
Route::post('updateaddressdetailsfinal','frontController@updateaddressdetailsfinal')->name('updateaddressdetailsfinal');
Route::post('setaddress','frontController@setaddress')->name('setaddress');

Route::post('orderideatils','frontController@orderideatils')->name('orderideatils');
Route::post('cancelorder','frontController@cancelorder')->name('cancelorder');
Route::post('cancelorderload','frontController@cancelorderload')->name('cancelorderload');
Route::post('webupdateprofile','frontController@webupdateprofile')->name('webupdateprofile');
Route::post('updatereddempoint', 'frontController@updatereddempoint')->name('updatereddempoint');

// Route::get('restauranthome/{id}','Restaurant@restauranthome')->name('restauranthome');
// Route::get('/subrestaurant/{id}','Restaurant@subrestaurant')->name('subrestaurant');
// Route::post('getpriceweight','Restaurant@getpriceweight')->name('getpriceweight');
// Route::get('resturantproductweb/{id}','Restaurant@resturantproductweb')->name('resturantproductweb'); 
// Route::get('resturantproductweb/getbyresturantvarient/{id}','Restaurant@resturantwebvarient');
// Route::get('resturantproductdetail/{id}','Restaurant@resturantproductdetail')->name('resturantproductdetail');
// Route::post('resturantgetproductlist','Restaurant@resturantgetproductlist')->name('resturantgetproductlist');
// Route::post('resturantaddtobag','Restaurant@resturantaddtobag')->name('resturantaddtobag');
// Route::get('resturantcart/{storeid}','Restaurant@resturantcart')->name('resturantcart');
// Route::post('restaurantupdateqtycart','Restaurant@restaurantupdateqtycart')->name('restaurantupdateqtycart');
// Route::post('restaurantremovecartitem','Restaurant@restaurantremovecartitem')->name('restaurantremovecartitem');
// Route::get('resturantcheckout/{storeid}','Restaurant@resturantcheckout')->name('resturantcheckout');
// Route::post('resturantplaceorder','Restaurant@resturantplaceorder')->name('resturantplaceorder');


Route::get('parcelhome/{id}','Parcel@parcelhome')->name('parcelhome');
Route::get('parcelsender/{id}/{storeid}','Parcel@parcelsender')->name('parcelsender');
Route::get('destination/{storeid}/{id}','Parcel@destination')->name('destination');
Route::get('parceldetails/{storeid}/{receiverid}/{senderid}','Parcel@parceldetails')->name('parceldetails');

Route::post('addsenderaddress','Parcel@addsenderaddress')->name('addsenderaddress');
Route::post('addreceiveraddress','Parcel@addreceiveraddress')->name('addreceiveraddress');
Route::get('parcelgettimeslot','Parcel@parcelgettimeslot')->name('parcelgettimeslot');
Route::post('addparceldetails','Parcel@addparceldetails')->name('addparceldetails');
Route::get('parcelconfirmdetails/{storeid}/{parceldetailid}','Parcel@parcelconfirmdetails')->name('parcelconfirmdetails');
Route::get('parcelconfirmdetails/{storeid}/{receiverid}/{senderid}','Parcel@parcelconfirmdetails')->name('parcelconfirmdetails');
Route::post('addorder','Parcel@addorder')->name('addorder');

});

Route::get('register','AuthController@createRegister')->name('register');
Route::post('register','AuthController@storeRegister')->name('registerdata');
Route::post('front/login','AuthController@createAuthenticate')->name('front.login');
Route::get('/','\App\Http\Controllers\FrontController@home')->name('home');
Route::group(['namespace'=>'Webfresh','middleware' =>'auth'],function(){ 
/******************Fresh***************************************************/

Route::post('adduseraddress', '\App\Http\Controllers\FrontController@addUseraddress')->name('adduseraddress');
Route::post('getarea', '\App\Http\Controllers\FrontController@getArea')->name('getarea');
Route::get('gettimeslot','\App\Http\Controllers\FrontController@gettimeSlot')->name('gettimeslot');


Route::get('grocerystore/{id}','\App\Http\Controllers\FrontController@groceryStore')->name('grocerystore');
Route::post('getcategoryproduct','\App\Http\Controllers\FrontController@getcategoryProduct')->name('getcategoryproduct');
Route::post('getproductthroughname','\App\Http\Controllers\FrontController@getproductThroughname')->name('getproductthroughname');

Route::post('addtobag', '\App\Http\Controllers\FrontController@addtoBag')->name('addtobag');
Route::post('addorder', '\App\Http\Controllers\FrontController@addOrder')->name('addorder');
Route::get('cart/{id}', '\App\Http\Controllers\FrontController@createCart')->name('cart');
Route::get('checkout/{id}', '\App\Http\Controllers\FrontController@checkOut')->name('checkout');
Route::post('updatecart', '\App\Http\Controllers\FrontController@updateCart')->name('updatecart');
Route::post('removecartitem', '\App\Http\Controllers\FrontController@removeCartitem')->name('removecartitem');
...
////////////////////Razorpay route///////////
Route::get('razorpay-payment', [RazorpayPaymentController::class, 'razorpay'])->name('razorpayView');
...
Route::post('paystack','StripePaymentController@paystack')->name('paystack');

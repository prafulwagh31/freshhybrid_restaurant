   ...
   public function today_order_pharmacy(Request $request)
    {
      if(Session::has('vendor'))
      {
       ...
       $current2 = date('d-m-Y', strtotime($currentDate.' + '.$day.' days'));
        ...
        return view('pharmacy.oder_incentive.today_order', compact("vendor_email","details", "vendor","todayorder","delivery_boy","boy_area_id"));
	 }
	else
	 {
    ...
    public function pharmacynext_day(Request $request)
    {
      ...
      if(Session::has('vendor'))
      {
        ...
        if(count($delivery_boy)>0){
         ...
         return view('pharmacy.oder_incentive.next_day_order', compact("vendor_email","details", "vendor","nextdayorder","delivery_boy","boy_area_id"));
	 }
	else
	 {
	    return redirect()->route('vendorlogin')->withErrors('please login first');
...
public function pharmacy_complete_order(Request $request)
    {
      if(Session::has('vendor'))
      {
     $currentDate = date('Y-m-d');
    ...
    if(count($delivery_boy)>0){
         ...
         return view('pharmacy.oder_incentive.complete_order', compact("vendor_email","details", "vendor","nextdayorder","delivery_boy","boy_area_id"));
	...
	else
	 {
      ...
      public function pharmacy_assigned_order(Request $request)
    {
     if(Session::has('vendor'))
      {

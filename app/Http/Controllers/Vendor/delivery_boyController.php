        ...
        $old_delivery_boy_image=$request->old_delivery_boy_image;
            ...
            $request,
                [
                    ...
                    'delivery_boy_image'=>'required|mimes:jpeg,png,jpg|max:2048',
                ],
                [
     ...
     if(Session::has('vendor'))
      {
       ...
       if($password!=$password2){
         ...
         if($password!="" && $password2!="")
        {
            ...
            {
                $new_pass=Hash::make($password);
                $value=array('delivery_boy_name'=>$delivery_boy_name,'delivery_boy_image'=>$delivery_boy_image, 'delivery_boy_pass'=>$new_pass,'delivery_boy_phone'=>$code.$delivery_boy_phone, 'updated_at'=>$updated_at,'dboy_comission'=>$comission);
            }
            
        }
        else
        {
            $value=array('delivery_boy_name'=>$delivery_boy_name,'delivery_boy_image'=>$delivery_boy_image, 'delivery_boy_phone'=>$code.$delivery_boy_phone,'updated_at'=>$updated_at,'dboy_comission'=>$comission);
        }

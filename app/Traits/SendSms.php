...
trait SendSms {
    ...
    {
        $getInvitationMsg = "Your Dinasibag order #".$cart_id." containing " .$prod_name." with amount rs ".$price2. " is placed successfully. You can expect your item(s) to be delivered on ".$delivery_date." between ".$time_slot.".";
    ...
    if($smsby->status==1){       
     ...
     public function delout($cart_id, $prod_name, $price2,$currency,$ord,$user_phone) 
     {
         if($ord->payment_method=="COD" || $ord->payment_method=="cod"){
                         $getInvitationMsg = "Your Dinasibag order #".$cart_id." containing " .$prod_name." of with amount ".$price2. "  is out for delivery. Get ready."; 
            }
            else{
                  $getInvitationMsg = "Your Dinasibag order #".$cart_id." containing " .$prod_name." of with amount ".$price2. "  is out for delivery. Get ready."; 
     ...
     public function delcomsms($cart_id, $prod_name, $price2,$currency,$user_phone)
     {
         $getInvitationMsg = "Delivery Completed: Your order id #".$cart_id." contains of " .$prod_name." of price " .$currency->currency_sign." ".$price2. " is Delivered Successfully.";
          ...
          $getInvitationMsg = "Your Dinasibag order #".$cart_id." was delivered. Keep ordering from your favorite stores!";
     ...
     public function otpmsg($otpval,$user_phone) 
     {
        ...
        $getInvitationMsg = "".$otpval.". is the OTP to verify your mobile number with Dinasibag. Please enter the OTP to continue. Do not share with anyone.";
...
//////Store Payout////////
 ...
 public function sendrejectmsg($cause,$user,$cart_id) {
    ...
    if($smsby->status==1){       
     ...
     public function rechargesms($user_name, $add_to_wallet,$user_phone) {
       $getInvitationMsg = "Your Dinasi Bag wallet is successfully recharged with amount ".$add_to_wallet. ".";
